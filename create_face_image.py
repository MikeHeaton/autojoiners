...
def create_object_from_recipe(arg_name, all_args, recipe_book):
...
if __name__ == "__main__":
    ...
    framesource = create_object_from_recipe(
                                    'mode', args, ALLOWED_INPUT_MODES_AND_ARGS)
    imagesource = aj_imagesource.FacesFromVideo(
                                    framesource,
                                    pertubation=args['pertubation'],
                                    border=args['border_size'])
    shatter = create_object_from_recipe(
                                    'shatter', args, ALLOWED_SHATTERS_AND_ARGS)
