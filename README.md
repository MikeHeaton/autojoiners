...
<img src=“sample_images/picasso_manwithviolin.jpg" alt="Drawing" style="width: 200px;"/>
<img src="sample_images/hockney_joiner.jpg" alt="Drawing" style="width: 200px;"/>
...
#### Example:
Try `python create_face_image.py file testmov.mov -size 800 700 -filename sampleoutput.jpg -shatter Voroi`
